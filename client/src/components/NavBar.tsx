...
import { AppBar, Box, Button, Toolbar, Menu, MenuItem, IconButton, useTheme, InputBase, Typography } from '@mui/material';

export const NavBar = ({ user, isSidebarOpen, setIsSidebarOpen }: any) => {
            ...
            <FlexBetween gap="1.5rem">
                ...
                <FlexBetween>
                    <Button
                        ...
                        <Box component='img' alt='profile' src={profileImage} height='32px' width='32px'
                        ...
                        <Box textAlign='left'>
                            ...
                            <ArrowDropDownOutlined sx={{ color: theme.palette.secondary[300], fontSize: '25px' }}></ArrowDropDownOutlined>
                    </Button>
