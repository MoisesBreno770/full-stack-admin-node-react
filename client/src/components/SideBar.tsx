...
export const SideBar = ({ user, drawerWidth, isSidebarOpen, setIsSidebarOpen, isNonMobile }: any) => {
                        ...
                        {navItems.map(({ text, icon }) => {
                            ...
                            return (
                                <ListItem key={text} disablePadding>
                                    <ListItemButton onClick={() => { navigate(`/${lcText}`); setActive(lcText) }} sx={{
                                        backgroundColor: active === lcText ?
                                            theme.palette.secondary[300] : 'transparent',
                                        color: active === lcText ? theme.palette.primary[600] : theme.palette.secondary[100]
                                    }}>
                                        <ListItemIcon sx={{ ml: '2rem', color: active === lcText ? theme.palette.primary[600] : 
                ...
                <Box position="absolute" bottom="2rem">
                    ...
                    <FlexBetween textTransform='none' gap='1rem' m='1.5rem 2rem 0 3rem'>
                        ...
                        borderRadius='50%' sx={{ objectFit: 'cover'}}/>
                            ...
                            <SettingsOutlined sx={{ color: theme.palette.secondary[300], fontSize: '25px'}}></SettingsOutlined>
                    </FlexBetween>
                </Box>
            </Drawer>
        )}
