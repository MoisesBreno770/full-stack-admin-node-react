...
export const Dashboard = () => {
    ...
    const isNonMediumScreens: any = useMediaQuery("(min-width: 1200px)");
        ...
        <Box m='1.5rem 2.5rem'>
            ...
            >
                ...
                <StatBox
                    ...
                    icon={
                        <Email sx={{ color: theme.palette.secondary[300], fontSize: '26px' }}></Email>
                    }
                />
                <StatBox
                    title='Sales Today'
                ...
                >
                    <OverviewChart view='sales' isDashboard={true}></OverviewChart>
                </Box>
                <StatBox
                    title='Monthly Sales'
