...
const Product = ( {_id, name, description, price, rating, category, supply, stat }: any) => {
    ...
    return (
        ...
        >
            ...
            <CardActions>
                <Button variant="contained" size='small' onClick={() => setIsExpanded(!isExpanded)}>See More</Button>
            </CardActions>
            <Collapse
                in={isExpanded}
                timeout='auto'
...
export const Products = () => {
    ...
    console.log(data);
    const isNonMobile: any = useMediaQuery('(min-width:1000px)');
